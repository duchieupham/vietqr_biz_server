...
import com.vietqr.org.grpc.client.qrgenerator.QRGeneratorDTO;
import com.vietqr.org.grpc.client.qrgenerator.StaticQRCreateDTO;
...
public class TestQRGeneratorController {
    ...
    ResponseEntity<Object> getBankAccountReceiveByBankId(
            ...
            @Validated @RequestBody StaticQRCreateDTO dto
    ) {
        try {
            dto.setToken(token);
            QRGeneratorDTO data = qrGeneratorClient.generateStaticQR(dto);
